...
def joystick_callback(joy):
    ...
    vertical_vel = round(joy.axes[L3_Y], 1)
    ...
    if joy.buttons[R1] == 1 and joy.buttons[L1] == 0:
        ...
        for_back_vel_r, r2_vel_adj_flag, l2_vel_adj_flag = funcs.get_vertical_vel(joy.axes[R2], joy.axes[L2], r2_vel_adj_flag, l2_vel_adj_flag)
        for_back_vel_l = for_back_vel_r
